...
class Tipo_libro extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('parametrizacion/' . modelo(), 'Controlador_model');
        $this->controlador = controlador();
        $this->titulo_controlador = humanize($this->controlador);
        $this->url = base_url() . 'parametrizacion/' . $this->controlador;
        $this->vista = 'parametrizacion/' . $this->controlador . '/';
    }
